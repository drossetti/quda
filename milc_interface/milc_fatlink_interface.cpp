...
void qudaLoadFatLongLink(int precision, QudaFatLinkArgs_t fatlink_args, const double act_path_coeff[6], void* inlink, void* fatlink, void* longlink)
{
...
//  timer.mute();
  ...
  computeFatLongLinkQuda(local_fatlink, local_longlink, (void**)local_inlink, const_cast<double*>(act_path_coeff), &param, method);
  timer.check("computeFatLongLinkQuda");
  ...
  if(longlink){
    printfQuda("Printing llp\n");
    double* llp = (double*)longlink;
    printfQuda("%lf %lf, %lf %lf, %lf %lf\n", llp[0], llp[1], llp[2], llp[3], llp[4], llp[5]);
    printfQuda("%lf %lf, %lf %lf, %lf %lf\n", llp[6], llp[7], llp[8], llp[9], llp[10], llp[11]);
    printfQuda("%lf %lf, %lf %lf, %lf %lf\n", llp[12], llp[13], llp[14], llp[15], llp[16], llp[17]);
    printfQuda("\n");
  }
