#ifndef _TMCLOVER_CORE_H
#define _TMCLOVER_CORE_H
...
__global__ void twistCloverGamma5Kernel(double2 *spinor, float *null, double a, const double2 *clover, 
...
__global__ void twistCloverGamma5Kernel(double2 *spinor, float *null, const double a, const double b, const double c, const double2 *in, const float *null2, DslashParam param)
{
	return;
/*
...
__global__ void twistCloverGamma5Kernel(float4 *spinor, float *null, float a, float b, 
...
__global__ void twistCloverGamma5Kernel(float4 *spinor, float *null, float a, float b, float c,  const float4 *in,  const float *null2, DslashParam param)
{
	return;
/*
#ifdef GPU_NDEG_TWISTED_MASS_DIRAC
...
__global__ void twistCloverGamma5Kernel(short4* spinor, float *spinorNorm, float a, float b, 
...
__global__ void twistCloverGamma5Kernel(short4* spinor, float *spinorNorm, float a, float b, float c, const short4 *in, const float *inNorm, DslashParam param)
{
	return;
/*
#ifdef GPU_NDEG_TWISTED_MASS_DIRAC
